    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <Tabs defaultValue="business-info" className="space-y-6">
        <TabsList className="bg-[#1A1A1A] border-gray-800">
          <TabsTrigger value="business-info" className="text-gray-200 hover:text-[#84CC16] data-[state=active]:bg-[#84CC16] data-[state=active]:text-black">Business Information</TabsTrigger>
